...
var PlayerLayer = cc.Layer.extend({
    ...
    init: function () {
        ...
        if (this.playerType === PLAYER_AT_RIGHT) {
            ...
            this.addChild(this.avatarPanel, 0);

            // add avatar
            var avatarIndex = Math.floor(Math.random() * 16);
            ...
            var avatarGap = (this.avatarPanelWidth - this.avatarWidth) / 2;
            this.avatar
                .setPosition(this.avatarPanelLeftPadding + avatarGap,
            ...
            this.addChild(this.namePanel, 0);
            ...
            this.addChild(this.chipsLabel, 1);
            ...
            this.betChipsLabel.setColor(cc.color(255, 0, 0, 255));
            ...
            this.betChipsLabel.setPosition(this.betChips[this.currentChipLevel].getPositionX() +
                (this.betChips[this.currentChipLevel].getContentSize().width -
                    this.betChipsLabel.getContentSize().width) / 2,
                        this.betChips[0].getPositionY());
            this.addChild(this.betChipsLabel, 4 + this.currentChipLevel);

            // add acc chips
            this.accChipsLabel = new cc.LabelTTF("$ 10000", this.chipsFont, this.chipsSize);
            this.accChipsLabel.setColor(cc.color(255, 255, 0, 255));
            ...
            this.addChild(this.accChipsLabel, 4);

            // add action panel
            this.actionPanel = cc.Sprite.create(action_call_right);
            ...
            this.addChild(this.actionPanel, 20);
        }
    },
